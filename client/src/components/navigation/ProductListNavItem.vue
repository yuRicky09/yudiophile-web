<template>
  ...
  >
    ...
    <h3 class="font-bold uppercase">{{ categoryTitle }}</h3>
    <router-link
      :to="{ name: 'Products', params: { category: categoryTitle } }"
      class="group flex items-center gap-4 transition-colors hover:text-orange-300"
      ><span>SHOP</span
...
const imageUrl = useGetImageUrl(props.imgUrl);
</script>
